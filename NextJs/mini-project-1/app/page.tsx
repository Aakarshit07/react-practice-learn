  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-gray-600 max-2xl mx-auto mb-8">
          This is a Simple, clean website built with Next.js and Tailwind CSS.
          Prefert for beginners learning web developement.
        </p>

        <div className="space-x-4">
          <button className="bg-blue-400 text-white px-3 py-3 rounded-lg hover:bg-blue-500 transition-colors font-semibold">
            Get Started
          </button>
      ...
      <div className="grid md:grid-cols-3 gap-8 mb-16">
        <div className="text-center p-6 bg-white rounded-lg shadow-sm border border-gray-200">
          ...
          <h3 className="text-xl font-semibold text-grap-900 mb-3">Fast</h3>
